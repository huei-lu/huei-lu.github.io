...
$(function () {
    $(window).scroll(function () {
        // 捲軸往下拉 gotop和messenger會出現
        if ($(this).scrollTop() > 300) {
            $('#gotop,#messenger').fadeIn();
        }
        else {
            $('#gotop,#messenger').fadeOut();
        }
        
    });
    
    // 點擊gotop後回到網站最上方, 不需要包在window裡
...
$(function () {
    ...
    $('#accordion div').click(function () {
        $('#accordion div,.submenu').removeClass('btnNow');
...
$(document).ready(function () {
    $('.pd_gallery').imagesLoaded(function () {
        $("#exzoom").exzoom({
            autoPlay: false,
        });
